...
**[ForwardKazekage72/youtube-fix](https://github.com/ForwardKazekage72/youtube-fix)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/ForwardKazekage72/youtube-fix/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `ForwardKazekage72/youtube-fix`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/ForwardKazekage72/youtube-fix/releases/latest) и скачайте **`.rar`** (предпочтительно)
